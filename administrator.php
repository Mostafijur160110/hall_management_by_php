...
.p{padding:20px;
 ...
 .administrator{background-color: pink;
         padding: 30px;
         border: 10px;
         margin-left: 16px;
		 margin-right: 16px;
...
<div class="row">
 ...
 <h1> <b><i>Bangabandhu Sheikh Mujibur Rahman Hall</i></b> <P>(Administrator)</P> </h1>
...
<p style="font-size:18px; padding-top:30px; text-align:justify;">
 The Hall Administrator is integral to the smooth running of the Hall. Our Hall Administrator, Mr. Mushfiqur Rahim,  , is responsible for the good administration of the Hall in close liaison with the Hall Master, the Wardens and Sub-Wardens.
 </p>
</div>
</div>
</div> 
