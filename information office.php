...
<h1> <b><i>Bangabandhu Sheikh Mujibur Rahman Hall</i></b> <P>(Information Office)</P> </h1>
...
if($con)
{ 
	$sql = "SELECT * from `information office`";
...
?>
   <tr>
   	   ...
   	   <td> <?php echo $row['Student Data']; ?> </td>
