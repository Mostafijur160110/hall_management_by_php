...
<h1> <b><i>Bangabandhu Sheikh Mujibur Rahman Hall</i></b> <P>(Sports Room)</P> </h1>
...
?>
   <tr>
   	   ...
   	   <td> <?php echo $row['Carrom Board']; ?> </td>
   	   <td> <?php echo $row['Chess Board']; ?> </td>
